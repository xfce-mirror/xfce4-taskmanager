...
#define COLUMN_PROPERTIES "expand", FALSE, "clickable", TRUE, "reorderable", TRUE, "resizable", TRUE, "visible", visible
	...
	g_object_get (treeview->settings, "column-group_vsz", &visible, NULL);
	...
	g_object_get (treeview->settings, "column-group_rss", &visible, NULL);
	...
	g_object_get (treeview->settings, "column-group_cpu", &visible, NULL);
